...
def target_attainment_rows(
    ...
    rows = [
        ...
        ["Underdeployment class", _fmt_value(artifact.get("underdeployment_classification"))],
        ["Reason code", _fmt_value(artifact.get("underdeployment_reason_code"))],
        ["Action required", _fmt_value(artifact.get("action_required"))],
        ["Operator action", _fmt_value(artifact.get("operator_action"))],
        ["Residual undeployed cash", _fmt_money(artifact.get("residual_undeployed_cash"))],
        ...
        ["Partial buys", _fmt_value(artifact.get("partial_buy_count"))],
        ["Unresolved orders", _fmt_value(artifact.get("posttrade_unresolved_orders_count"))],

...
def main(argv=None):
    ...
    print(json.dumps({'certification': certificate['status'], 'parity': parity['status'], 'shadow': shadow['status']}))
    return 0 if certificate['status']=='CERTIFIED' and parity['UNEXPLAINED']==0 and shadow['status']=='PASS' else 1

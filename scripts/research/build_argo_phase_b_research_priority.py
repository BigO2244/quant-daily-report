    ...
    *,
    ...
    rows = [
        _priority_row(
            ...
            blockers=[
                "liquidity_evidence_failed",
                "liquidity_capacity_failed",
                "capacity_below_5pct_adv_policy",
                "not_shadow_readiness_eligible",
            ],
            next_action="Do not run Shadow-readiness review for the current Phoenix Phase B candidate; revisit only with new candidate evidence or owner-approved capacity policy change.",
            stop_research="Stop additional Phoenix alpha tuning and Shadow-readiness work for the current candidate after Phase C capacity failure.",
            rationale=[
                ...
                f"Phase C liquidity classification is {phoenix_c_classification}; the vendor dependency is cleared but measured capacity is adverse.",
            ],
    ...
    payload = {
        ...
        "highest_roi_research_task": {
            "sleeve_id": "cassiopeia",
            "task": "Build a PIT-safe event taxonomy and event-tape contract.",
            "reason": "Phoenix's vendor blocker is cleared and its current candidate failed capacity; Cassiopeia is now the largest unresolved research-data contract.",
        },
        "biggest_platform_blocker": {
            "blocker": "PIT event taxonomy and event-tape contract missing for event-driven research.",
            "affected_work": ["Cassiopeia Phase C", "event-driven validation", "future event-sleeve Shadow readiness"],
        },
        "dependency_map": {
            "phoenix": ["new candidate evidence or owner-approved capacity policy change"],
        ...
        "reason_codes": [
            ...
            "phoenix_liquidity_capacity_failed",

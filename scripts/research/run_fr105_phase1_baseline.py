#!/usr/bin/env python3
"""Build the FR-105 Phase 1 current-policy baseline artifact."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the FR-105 Phase 1 current-policy baseline.")
    ...
    path, payload = write_fr105_phase1_baseline(

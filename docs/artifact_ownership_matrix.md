...
| Test / smoke residue | Validation | Tests and local smoke scripts | Tests only | LOW | Not production evidence. | UNKNOWN for operations. | Should be isolated by future FR-020 work. |

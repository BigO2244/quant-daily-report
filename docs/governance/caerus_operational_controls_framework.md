...
| VM validation gate | `scripts/ops/run_vm_validation.sh` | Dirty VM tree, missing VM venv/python/pytest, operational validation failure, compile/test failures | FAIL | Deployment validation exits non-zero | Governance/deploy | `[VM_VALIDATION][FAIL/PASS]` |

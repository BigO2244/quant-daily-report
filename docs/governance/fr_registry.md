...
- FR-DH: Data Hydration Governance Package (`DRAFT_RESEARCH`) is a non-numbered
  ...
  submission, cron, allocation, strategy behavior, sleeve consumption, or
  promotion state.
  ...
  The data-trust summary renders that observability state into advisory JSON
  and markdown for future dashboard/email visibility without changing those
  surfaces yet.

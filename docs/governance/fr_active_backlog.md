...
| FR-069 Research Lab / Modular Sleeve Architecture | Architecture / Design | `ACTIVE_PHASE_A` | NONE (design-only) | FR-068 PIT foundation, existing sleeve specs (FR-050..053, 067), alpha_lab harness, `docs/governance/caerus_investment_doctrine.md` | primary_active_phase_a_design | Primary active architecture/research workstream. Phase A architecture package is `docs/governance/fr_active/fr_069_phase_a_architecture_package.md`: Canonical Sleeve Protocol, Registry-Onboarding Architecture, Research Lab Operating Model, Future Sleeve Inventory, and recommended Phase B roadmap. No production refactor; no registry behavior change; Orion/Lyra rationalization remains future data-driven work. | Delete the Phase A architecture package/design doc; nothing is wired. No code, execution, registry, or strategy behavior in scope. |
...
- **Date started:** 2026-06-10
- **Status:** `ACTIVE_PHASE_A` (architecture package; no production refactor)
- **Governance label:** RESEARCH_ONLY / NON_EXECUTIONAL
- **Priority state:** Primary active architecture/research workstream; Phase A

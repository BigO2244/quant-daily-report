...
| FR-069 | — (architecture) | Research Lab / modular sleeve architecture (design only; no production refactor) | `fr_active/fr_069_research_lab_modular_sleeve_architecture.md`; Phase A package: `fr_active/fr_069_phase_a_architecture_package.md` | ACTIVE_PHASE_A 2026-06-12 — primary active architecture workstream; canonical sleeve protocol, registry-onboarding architecture, research lab operating model, future sleeve inventory, and Phase B roadmap; governance/spec/test planning only | none (design spec) | n/a |

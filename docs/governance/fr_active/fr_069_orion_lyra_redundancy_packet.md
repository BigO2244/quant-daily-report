...
| Sleeve manifest | `research_registry/sleeves/manifest.json` | Orion and Lyra are `current_shadow_challenger` / `shadow_observed`; both require decision-grade PIT evidence and owner approval before promotion, retirement, rename, or allocation changes. |

...
Implement feature-store prototypes and P3 observe-only normalizers, starting
with deterministic fundamental-feature scaffolding and PIT ETF/index membership
normalization. Keep approved env-file or exported vendor keys outside the

...
synchronized while implementing feature-store prototypes and P3 normalizers. Do
not enforce catalog checks in runtime consumers until the schema, catalog rows,
and migration gates are approved.

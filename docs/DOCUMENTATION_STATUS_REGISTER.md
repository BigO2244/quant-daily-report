...
| `docs/governance/decision_records/generic_live_v1_dynamic_balance_owner_decision_20260824.json` | `CANONICAL_OWNER_POLICY_AUTHORITY` | Brett-approved cash-only dynamic Live policy superseding the fixed-$460 artifacts: no nominal ceiling, 95% of fresh broker net equity gross cap, buys limited by zero-pending-transfer cash and 5% reserve, no buying power/margin/borrowing/unsettled funds; grants no execution authority by itself |

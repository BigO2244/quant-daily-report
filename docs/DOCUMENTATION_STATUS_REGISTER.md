...
| `docs/governance/proposals/generic_live_v1_owner_decision_2026-08-25.pending.json` | `RESEARCH_OR_PROPOSAL` | Corrected same-terms Lyra-only Live v1 proposal for Tuesday execution from Monday's completed post-freeze target; status `PENDING_OWNER_APPROVAL`, with no approval, activation, or execution authority |

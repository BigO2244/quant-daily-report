...
| `docs/governance/proposals/adaptive_shadow_v1_policy_candidate.json` | `RESEARCH_OR_PROPOSAL` | Exact conservative Shadow-only eligible-set rule, objective weights, limits, fallback, and evidence gate pending owner approval; grants no promotion, execution, activation, or Paper/Live authority |
| `docs/governance/proposals/ADAPTIVE_SHADOW_V1_DECISION_BRIEF.md` | `RESEARCH_OR_PROPOSAL` | Plain-language owner decision brief for the hash-bound adaptive Shadow v1 candidate |
